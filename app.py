...
if uploaded_image is not None:
    ...
    smaller_image = image.resize((150, 150))  # You can adjust the size as needed
    
    # Display the smaller uploaded image
    st.image(smaller_image, caption="Uploaded Image (Smaller)", use_column_width=True)

    # Resize the image to the desired dimensions for prediction
...
This code adds a CSS class to the logo image to achieve rounded edges using HTML and CSS.
